...
// int main() {
//     int n;
//     cin >> n;  // size of the S (e.g., 7 or 9 looks good)
//
//     for (int i = 0; i < n; i++) {
//         for (int j = 0; j < n; j++) {
//             // Conditions for letter 'S'
//             if (i == 0 || i == n/2 || i == n-1)  // top, middle, bottom rows
//                 cout << "*";
//             else if (i < n/2 && j == 0)  // upper left side
//                 cout << "*";
//             else if (i > n/2 && j == n-1)  // lower right side
//                 cout << "*";
//             else
//                 cout << " ";
//         }
